...
function _page($$payload) {
  $$payload.out.push(`<div class="mx-8 mb-8 mt-8 space-y-4 bg-background"><h1 class="scroll-m-20 text-balance text-4xl font-extrabold tracking-tight">Bios Files</h1> `);
  Table($$payload, {
    children: ($$payload2) => {
        ...
        children: ($$payload3) => {
          Table_row($$payload3, {
            children: ($$payload4) => {
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<!---->Microsoft - Xbox - BIOS Images`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<!---->Nintendo - GameCube - BIOS Images`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<!---->Sony - PlayStation - BIOS Images`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<!---->Sony - PlayStation 2 - BIOS Images`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              ...
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<a class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground" href="https://archive.org/download/2019_11_25_redump_bios">Download</a>`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              ...
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<a class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground" href="https://archive.org/download/tosec_fw_os">Download</a>`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              ...
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<a class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground" href="https://myrient.erista.me/files/Internet%20Archive/chadmaster/RetroarchSystemFiles/Retroarch-System/">Download</a>`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<a class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground" href="https://archive.org/download/RetroarchSystemFiles/Retroarch-System/">Download</a>`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!----> `);
          ...
          Table_row($$payload3, {
            children: ($$payload4) => {
              ...
              Table_cell($$payload4, {
                children: ($$payload5) => {
                  $$payload5.out.push(`<a class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground" href="https://mega.nz/folder/9ZdQwaaY#u63KaI0MsKcIqWE2GQmUuA">Download</a>`);
                },
                $$slots: { default: true }
              });
              $$payload4.out.push(`<!---->`);
