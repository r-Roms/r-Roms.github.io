...
function _page($$payload) {
  $$payload.out.push(`<div class="mx-8 mb-8 mt-8 space-y-4 bg-background"><h1 class="scroll-m-20 text-balance text-4xl font-extrabold tracking-tight">Nintendo GameCube</h1> <p class="leading-7 [&amp;:not(:first-child)]:mt-6">The RVZ format is recommended for use in the Dolphin Emulator, not real
        ...
        Dolphin Emulator.</p> <h2 class="mt-10 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">RVZ Downloads</h2> <div class="my-6 w-full overflow-y-auto">`);
  Table($$payload, {
    children: ($$payload2) => {
