...
<div class="mx-8 mb-8 mt-8 space-y-4 bg-background">
    ...
    <Table>
        ...
        <TableBody>
            <TableRow>
                <TableCell>Sega - Mega CD &amp; Sega CD (BIN/CUE)</TableCell>
                <TableCell
                    ><a
                ...
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                        href="https://archive.org/download/sega_mega-cd_sega-cd"
                        >Download</a
                    ></TableCell
                >
            </TableRow>
            <TableRow>
                <TableCell>Sega - Mega CD &amp; Sega CD (CHD) USA</TableCell>
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                        href="https://archive.org/download/chd_segacd/CHD-SegaCD-NTSC/"
                        >Download</a
                    ></TableCell
                >
            </TableRow>
            <TableRow>
                <TableCell>Sega - Mega CD &amp; Sega CD (CHD) EUR</TableCell>
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                        href="https://archive.org/download/chd_segacd/CHD-MegaCD-PAL/"
                        >Download</a
                    ></TableCell
                >
            </TableRow>
            <TableRow>
                <TableCell>Sega - Mega CD &amp; Sega CD (CHD) JPN</TableCell>
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                        href="https://archive.org/download/chd_segacd/CHD-MegaCD-NTSCJ/"
                        >Download</a
                    ></TableCell
                >
            </TableRow>
            <TableRow>
                <TableCell>Sega - Mega CD &amp; Sega CD (CHD) Bonus</TableCell>
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                ...
                <TableCell
                    ><a
                        class="text-primary font-medium underline underline-offset-4 md:text-base hover:bg-primary hover:text-primary-foreground"
                        href="https://archive.org/download/chd_segacd/CHD-SegaCD-Bonus/"
                        >Download</a
                    ></TableCell
                >
            </TableRow>
