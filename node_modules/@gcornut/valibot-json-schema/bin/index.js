...
).option("--jsonIndent <nb_spaces>", "JSON indent characters (defaults to 2 spaces).").action(
  (sourcePath, {
    type,
    ...
    const jsonSchemaString = wrapper_default(jsonSchema, null, Number.parseInt(jsonIndent) || jsonIndent || 2);
    if (out) {
